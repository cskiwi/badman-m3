...
export class TournamentMinMaxLevel1765713978891 implements MigrationInterface {
    name = 'TournamentMinMaxLevel1765713978891'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "event"."SubEventTournaments" DROP COLUMN "level"
        `);
        await queryRunner.query(`
            ALTER TABLE "event"."SubEventTournaments"
            ADD "minLevel" integer
        `);
        await queryRunner.query(`
            ALTER TABLE "event"."SubEventTournaments"
            ADD "maxLevel" integer
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "event"."SubEventTournaments" DROP COLUMN "maxLevel"
        `);
        await queryRunner.query(`
            ALTER TABLE "event"."SubEventTournaments" DROP COLUMN "minLevel"
        `);
        await queryRunner.query(`
            ALTER TABLE "event"."SubEventTournaments"
            ADD "level" integer
